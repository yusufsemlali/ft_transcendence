...
export default function LoginForm() {
    ...
    return (
        <div className="animate-fade-in" style={{ width: "100%", maxWidth: "320px" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "1.5rem", fontSize: "0.75rem", color: "var(--text-secondary)" }}>
                or
            </div>
            ...
            <form onSubmit={handleLogin}>
                ...
                <div style={{ marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                    ...
                    />
                    <label htmlFor="rememberMe" style={{ fontSize: "0.75rem", color: "var(--text-secondary)", cursor: "pointer" }}>
                        remember me
                    </label>
                </div>
