...
export default function Home() {
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ 
          ...
          <div className="stack-xl" style={{ position: "relative", zIndex: 2 }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
              ...
              <span style={{ fontSize: "10px", color: "var(--text-muted)", fontBold: "700", letterSpacing: "2px" }}>MANAGEMENT PORTAL</span>
            </div>
            ...
            <div style={{ display: "flex", gap: "16px" }}>
              <Link href={isAuthenticated ? "/tournaments" : "/register"} className="btn btn-primary" style={{ padding: "16px 32px", fontSize: "12px", fontWeight: "800", letterSpacing: "1px" }}>
            ...
            <div style={{ display: "flex", gap: "48px", marginTop: "60px" }}>
              {stats.map(stat => (
                <div key={stat.label}>
                  <div style={{ fontSize: "10px", color: "var(--text-muted)", fontMono: "true", letterSpacing: "2px", fontWeight: "700" }}>{stat.label}</div>
                  <div style={{ fontSize: "28px", color: "var(--text-primary)", fontWeight: "300" }}>{stat.value}</div>
                </div>
              ))}
            </div>
          </div>

          {/* Infrastructure Preview Card */}
          <div style={{ position: "relative" }}>
            <div className="glass-card" style={{
              ...
              <div style={{ marginTop: "32px", fontSize: "10px", color: "var(--text-muted)", fontMono: "true", letterSpacing: "2px", textAlign: "center" }}>SYSTEM_STATUS: OPERATIONAL</div>
            </div>
        ...
        <section style={{ padding: "100px 0", borderTop: "1px solid var(--border-color)" }}>
          <div style={{ marginBottom: "60px" }}>
            ...
            <div style={{ fontSize: "32px", fontWeight: "300", color: "var(--text-primary)" }}>Coordination Workflow.</div>
          </div>
          ...
          <div style={{ 
            ...
            {workflow.map((p, i) => (
              <div key={i} className="glass-card" style={{ padding: "40px", border: "1px solid var(--border-color)", display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                <div>
                  <h4 style={{ fontSize: "20px", fontWeight: "700", marginBottom: "12px", textTransform: "uppercase", letterSpacing: "-0.02em" }}>{p.title}</h4>
        ...
        <div className="glass-card" style={{
          ...
          <div className="stack-md">
            <h2 style={{ fontSize: "40px", fontWeight: "300", color: "var(--text-primary)" }}>Initialize Your Organization.</h2>
            <p style={{ color: "var(--text-muted)", fontSize: "1.1rem", maxWidth: "600px" }}>Connect with the definitively professional management system for tournament coordination.</p>
          </div>
      ...
      <footer className="footer" style={{ marginTop: "120px", maxWidth: "1200px", margin: "120px auto 0 auto" }}>
